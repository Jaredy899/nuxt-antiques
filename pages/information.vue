        ...
        <div class="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg transition-colors duration-200">
          ...
          <div class="space-y-4">
            ...
            <div class="mt-6">
              ...
              <p class="text-gray-600 dark:text-gray-300">We are located in the heart of historic Abingdon, Virginia, on West Main Street, across the street from <a href="https://abingdoncommons.com/" target="_blank" rel="noopener noreferrer" class="text-link-light dark:text-link-dark hover:underline transition-colors">Abingdon Commons</a>.</p>
            </div>
            <div class="mt-6">
