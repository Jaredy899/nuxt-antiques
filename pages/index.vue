        ...
        <div class="max-w-6xl mx-auto">
          <div class="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg transition-colors duration-200">
            <div class="max-w-3xl mx-auto text-center">
              ...
              <NuxtLink to="/information" class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-md transition-all duration-200 hover:shadow-lg hover:scale-105">
                Visit Our Store
              </NuxtLink>
            </div>
          </div>
